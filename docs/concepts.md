...
| The Kafka comparison, and the pairing it got wrong first | [m5-kafka-comparison.md](decisions/m5-kafka-comparison.md) |
| Real power loss, and the hole it found | [power-loss.md](decisions/power-loss.md) |
